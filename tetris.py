...
class Tetris:
    ...
    def render(self):
        ...
        for i in range(0, Tetris.BOARD_WIDTH * 25, 25):
            cv2.line(img, (i, 0), (i, Tetris.BOARD_HEIGHT * 25), (0, 0, 0), 1)
        for j in range(0, Tetris.BOARD_HEIGHT * 25, 25):
            cv2.line(img, (0, j), (Tetris.BOARD_WIDTH * 25, j), (0, 0, 0), 1)
        cv2.putText(img, str(self.total_lines), (100, 40), cv2.FONT_HERSHEY_DUPLEX, 1.5, (0, 255, 255), 3)
